...
<div class="container">
	...
	<pre class="text-center">
	  ...
	  <font color="red">Application Programming interface</font>의 줄임말
	  ...
	  <b>REST란?</b>
	  <font color="red">Representational State Transfer</font>의 줄임말로, 자원의 이름으로 구분하여 해당 자원의 상태를 교환하는것을 의미한다.
