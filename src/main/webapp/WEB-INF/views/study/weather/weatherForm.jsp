...
<div class="container">
  <h2>날씨정보 확인하기</h2>
  <hr/>
  <input type="button" value="현재위치보기" onclick="weatherCheck1()" class="btn btn-success text-center"/>
  <input type="button" value="현재위치날씨" onclick="weatherCheck2()" class="btn btn-primary mr-3 text-center"/><br/>
  <select name="jiyuk" id="jiyuk" onchange="weatherCheck3()" class="form-control mt-5">
